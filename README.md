...
## Features
- Immersive **video background** for a modern look
- Fully **responsive design** for desktop and mobile devices
- **Smooth animations** using AOS (Animate On Scroll)
- Interactive **contact form** with placeholders and input fields
- **Direct email sending** functionality via JavaScript
- **Social links** integration (Gmail, LinkedIn)
- Clean and minimal design for easy customization

## Technologies Used
- **HTML5** – structure of the webpage
- **CSS3** – styling, layout, and animations
- **JavaScript** – email sending functionality and interactivity
